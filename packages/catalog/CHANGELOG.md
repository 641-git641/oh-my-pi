...
- Added `delegation-bias` capability to tune agent subagent orchestration

### Changed

- Adjusted subagent delegation behavior for GPT-6 and newer OpenAI models to reduce over-delegation
